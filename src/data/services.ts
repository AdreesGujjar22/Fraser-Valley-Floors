...
const baseServices: Service[] = [
  // Concrete Coating
  {
    ...
    metaDescription: "Fraser Valley Floors provides durable epoxy coatings in Fraser Valley, BC for homes, garages, and commercial spaces with long-lasting protection.",
    description: [
  ...
  },
  {
    ...
    metaDescription: "Upgrade your garage with durable floor coatings in Fraser Valley, BC. Fraser Valley Floors delivers stain-resistant, long-lasting finishes.",
    description: [
  ...
  },
  {
    ...
    metaDescription: "Fraser Valley Floors installs warehouse floor coatings in Fraser Valley, BC designed for heavy traffic, durability, and easy maintenance.",
    description: [
  ...
  },
  {
    ...
    metaDescription: "Enhance outdoor spaces with patio coatings in Fraser Valley, BC. Fraser Valley Floors creates durable, weather-resistant concrete finishes.",
    description: [
  ...
  },
  {
    ...
    metaDescription: "Fraser Valley Floors installs polyaspartic coatings in Fraser Valley, BC for fast-curing, UV-resistant, and highly durable floor protection.",
    description: [
  ...
  },
  {
    ...
    metaDescription: "Protect floors with polyurethane coatings in Fraser Valley, BC. Fraser Valley Floors provides strong, chemical-resistant floor finishes.",
    description: [
  ...
  },
  {
    ...
    metaDescription: "Fraser Valley Floors creates decorative concrete in Fraser Valley, BC with stylish finishes that improve durability and curb appeal.",
    description: [
  ...
  },
  {
    ...
    metaDescription: "Fraser Valley Floors installs food-safe floor coatings in Fraser Valley, BC for hygienic, durable, and easy-to-clean commercial spaces.",
    description: [
  ...
  },
  {
    ...
    metaDescription: "Fraser Valley Floors provides studio floor coatings in Fraser Valley, BC with durable, seamless finishes for creative and work spaces.",
    description: [
  ...
  },
  {
    ...
    metaDescription: "Fraser Valley Floors installs shop floor coatings in Fraser Valley, BC for durable, stain-resistant surfaces built for daily use.",
    description: [
  ...
  // Flooring
  {
    ...
    metaDescription: "Fraser Valley Floors installs premium vinyl flooring in Fraser Valley, BC with stylish, waterproof, and low-maintenance solutions.",
    description: [
  ...
  },
  {
    ...
    metaDescription: "Fraser Valley Floors offers laminate flooring in Fraser Valley, BC with durable, attractive finishes for residential and commercial spaces.",
    description: [
  ...
  },
  {
    ...
    metaDescription: "Fraser Valley Floors installs hardwood flooring in Fraser Valley, BC with timeless beauty, lasting durability, and expert craftsmanship.",
    description: [
  ...
  },
  {
    ...
    metaDescription: "Fraser Valley Floors supplies and installs carpet tiles in Fraser Valley, BC for comfortable, durable, and easy-to-maintain interiors.",
    description: [
  ...
  },
  {
    ...
    metaDescription: "Fraser Valley Floors builds custom stairs in Fraser Valley, BC with quality materials, precision craftsmanship, and lasting style.",
    description: [
  ...
  },
  {
    ...
    metaDescription: "Fraser Valley Floors installs self-leveling floors in Fraser Valley, BC creating smooth, durable surfaces ready for any flooring system.",
    description: [
  ...
  },
  {
    ...
    metaDescription: "Fraser Valley Floors provides floor demolition in Fraser Valley, BC with safe, efficient removal services for residential and commercial projects.",
    description: [
