  ...
  head: () => ({
    meta: [
      { title: "Services | Flooring & Concrete Coatings | Fraser Valley Floors" },
      {
        name: "description",
        content:
          "Complete flooring and concrete coating services: epoxy, polyaspartic, garage coatings, hardwood, vinyl plank, laminate, custom stairs, and more.",
      },
        ...
        <div className="container-x">
          <div className="mb-10">
            ...
            <p className="mt-3 max-w-2xl text-foreground/80">
              Premium epoxy, polyaspartic, and decorative coating systems for garages, shops,
              warehouses, patios, and commercial spaces.
            </p>
          </div>
      ...
      <section className="section-y bg-surface/40">
        <div className="container-x">
          <div className="mb-10">
            ...
            <p className="mt-3 max-w-2xl text-foreground/80">
              Expert installation of vinyl plank, laminate, hardwood, carpet tile, custom stairs,
              and the prep work that makes them last.
            </p>
          </div>
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
